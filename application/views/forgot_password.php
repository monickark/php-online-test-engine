          ...
          <tr>
            ...
            <td width="750" valign="top"><br>
                ...
                <br>
                  <br>
                   <?php if(empty($s_pass)) { ?>
                  <form action="<?php echo base_url();?>forgot_password" method="post" name="login">
            ...
            <br>
            <span class="content">Password will be sent to your email id</span>
            
             <?php } else { ?> <span class="content"> <?php echo $s_pass; ?> </span> <?php } ?>
            </div>
            <br>
            <br>
            <br></td>
