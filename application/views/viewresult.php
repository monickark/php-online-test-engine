...
<h1>Result #
  <?=$result['result_id']?>
  <div style="float:right" > <?php echo anchor('result/',img('images/back.gif'));?> &nbsp; <a href="javascript:print();"><?php echo img('images/print.png');?></a> </div>
</h1>
<div id="body">
<?php
	if(isset($msg)){
...
<table bgcolor="#ffffff">
  ...
  <tr >
    <td bgcolor="#eeeeee" width="350px">Test Name</td>
    <td bgcolor="#eeeeee" ><?=$result['test_name']?></td>
  </tr>
  <tr>
    <td bgcolor="#ffffff">Correct Answers / Total Questions</td>
    <td bgcolor="#ffffff"><?php $correct=str_replace("2","0",$result['correct_answer']); $correct=explode(",",$correct); echo array_sum($correct); ?>
      /
      <?=$result['total_question']?></td>
  </tr>
  <tr>
    <td bgcolor="#eeeeee" >Obtained Percentage </td>
    <td bgcolor="#eeeeee"><?=$result['obtained_percentage']?>
      % </td>
  </tr>
  <tr>
