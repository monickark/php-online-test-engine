...
<div class="maincontentinner">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <tbody>
                        <?php $i=$Page_No+1; foreach($all_qns as $val) { ?>
                        <tr class="gradeA" id="<?php echo $val['qid'];?>">
                            <td><?php echo $i;?></td>
                            ...
                            <td><a href="<?php echo base_url();?>admin/edit_question/<?php echo $val['qid'];?>">Edit</a> | <a href="javascript:;" id="<?php echo $val['qid'];?>" class="deletequestion">Delete</a></td>
                        </tr>
                        <?php $i++; } ?>
                    </tbody>
                </table>
