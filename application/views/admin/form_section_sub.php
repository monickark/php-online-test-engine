                ...
                <div class="content">
                    ...
                    <form id="kl" class="stdform" action="<?php echo $form_url; ?>" method="post">
                    	...
                    	<p>
                        	<label>Section</label>
                            <span class="field">
                            <select name="section_ids[]" class="section_ids" multiple="multiple">
                                <?php
                                if( isset($all_section) ){
                                foreach($all_section as $val){
								?>
                                <option value="<?php echo $val['pid'];?>" <?php echo set_select('section_ids[]', $val['pid'], isset($details['section_ids']) && is_array($details['section_ids']) && in_array($val['pid'], $details['section_ids'])); ?>><?php echo $val['title'];?></option>
                             	<?php
								}
								}
								?>
