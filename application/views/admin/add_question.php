...
jQuery(document).ready(function() {
     ...
     <ul class="maintabmenu">
			...
			<?php } ?>
                    ...
                    <form id="kl" class="stdform" action="<?php echo base_url();?>admin/add_question" method="post">
                     ...
                     <p>
                         ...
                         <p>
                            ...
                            <select name="sub_id" class="sub_id">
                                <option value="">Select</option>
                                <?php foreach($all_sub as $val) { ?>
                                <option value="<?php echo $val['sub_id'];?>" <?php echo set_select('sub_id', $val['sub_id']); ?>><?php echo $val['subject'];?></option>
                             <?php } ?>
                            </select>
                            </span>
                        </p>
                        ...
                        <p>
                            ...
                            <select name="pid" class="p_id">
                                <option value="">Select</option>
                                <?php foreach($all_pass as $val) { ?>
                                <option value="<?php echo $val['pid'];?>" <?php echo set_select('pid', $val['pid']); ?>><?php echo $val['passage_title'];?></option>
                             <?php } ?>
                            </select>
                            </span>
                        </p>
                         ...
                         <p>
                            ...
                            <span class="field"><textarea class="tinymce" id="qn" name="question" cols="" rows=""><?php echo set_value('question'); ?></textarea> </span>
                        </p>
                        
                        <p>
                        	<label>Option 1</label>
                            <span class="field"><textarea class="tinymce" id="op1" name="ops1" cols="" rows=""><?php echo set_value('ops1'); ?></textarea> </span>
                        </p>
                        
                         <p>
                        	<label>Option 2</label>
                            <span class="field"><textarea class="tinymce" id="op2" name="ops2" cols="" rows=""><?php echo set_value('ops2'); ?></textarea> </span>
                        </p>
                        
                         <p>
                        	<label>Option 3</label>
                            <span class="field"><textarea class="tinymce" id="op3" name="ops3" cols="" rows=""><?php echo set_value('ops3'); ?></textarea> </span>
                        </p>
                        
                        <p>
                        	<label>Option 4</label>
                            <span class="field"><textarea class="tinymce" id="op4" name="ops4" cols="" rows=""><?php echo set_value('ops4'); ?></textarea> </span>
                        </p>
                        
                        <p>
                        	<label>Answer</label>
                            <span class="field"><input type="text" name="answer" value="<?php echo set_value('answer'); ?>" class="mediuminput" /></span> <small class="desc">Type 1 or 2 or 3 or 4</small>

                        </p>

                        <p class="stdformbutton">
                             <input type="submit" class="stdbtn btn_black" value="Add Question" name="add_qn" />
                        </p>
