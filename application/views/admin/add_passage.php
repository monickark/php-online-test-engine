	 ...
	 jQuery(".batchid").change(function () {
		   ...
		   var domain = "<?php echo base_url();?>";
			...
			<?php } ?>
                    ...
                    <form id="kl" class="stdform" action="<?php echo base_url();?>admin/add_passage" method="post">
                     ...
                     <p>
                         ...
                         <p>
                            ...
                            <span class="field"><input type="text" name="p_name" value="<?php echo set_value('p_name'); ?>" class="mediuminput" /></span>
                        </p>
                        
                            <p>
                        	<label>Passage Description</label>
                            <span class="field"><textarea class="tinymce" name="p_desc" cols="" rows=""><?php echo set_value('p_desc'); ?></textarea> </span>
                        </p>
                  

                        <p class="stdformbutton">
                             <input type="submit" class="stdbtn btn_black" value="Add Passage" name="add_pass" />
                        </p>
