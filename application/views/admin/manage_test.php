...
jQuery(document).ready(function(){
	...
	jQuery('a.deletetest').live("click", function() {
		var pp = jQuery(this);
		...
		if(c) {			
			...
			jQuery.ajax({
				...
				success: function(html){
					...
					jAlert('Test Deleted Successfully', 'Notification Dialog');
				}
			});
		}
		return false;
...
<div class="maincontentinner">
                ...
                <div class="content">
                 ...
                 <p style="float:right; clear:both"> <a href="<?php echo base_url();?>admin/add_test/" class="stdbtn btn_black">Add New Test Client</a></p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                       	<tr>
                            ...
                            <th class="head1">Test Client Name</th>
                            <th class="head1">Test Type</th>
                            <th class="head1">Test Vertical</th>
                    ...
                    <tbody>
                        ...
                        <tr class="gradeA" id="<?php echo $val['pid'];?>">
                            ...
                            <td><a href="<?php echo base_url();?>admin/edit_test/<?php echo $val['pid'];?>">Edit</a> | <a href="javascript:;" id="<?php echo $val['pid'];?>" class="deletetest">Delete</a></td>
                        </tr>
                        <?php $i++; } ?>
                    </tbody>
                </table>
