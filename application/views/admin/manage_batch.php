...
<div class="maincontentinner">
                ...
                <div class="content">
                 ...
                 <p style="float:right; clear:both"> <a href="<?php echo base_url();?>admin/add_batch/" class="stdbtn btn_black">Add Batch</a></p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <tbody>
                        ...
                        <tr class="gradeA" id="<?php echo $val['batch_id'];?>">
                            <td><?php echo $i;?></td>
                            <td><?php echo $val['batch_name']; ?></td>
                            <td><?php echo $val['date'];?></td>
                            <td><a href="<?php echo base_url();?>admin/edit_batch/<?php echo $val['batch_id'];?>">Edit</a></td>
                        </tr>
                        <?php $i++; } ?>
                    </tbody>
                </table>
