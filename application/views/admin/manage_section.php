...
jQuery(document).ready(function(){
	...
	jQuery('a.deletesection').live("click", function() {
		var pp = jQuery(this);
		...
		if(c) {			
			...
			jQuery.ajax({
				type: "POST",
				url: domain+"admin/delete_section",
				data: str,
				cache: false,
				success: function(html){
					...
					jAlert('Section Deleted Successfully', 'Notification Dialog');
				}
			});
		}
		return false;
...
<div class="maincontentinner">
                ...
                <div class="content">
                 ...
                 <p style="float:right; clear:both"> <a href="<?php echo base_url();?>admin/add_section/" class="stdbtn btn_black">Add Section</a></p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                    ...
                    <thead>
                       	<tr>
                            ...
                            <th class="head1">Section Name</th>
                            <th class="head1">Sectors</th>
                    ...
                    <tbody>
                        ...
                        <tr class="gradeA" id="<?php echo $val['pid'];?>">
                            ...
                            <td><?php
                            $query = $this->db->query('SELECT A.`pid`, A.`title` FROM `sector` A LEFT OUTER JOIN `section_sector` B ON B.`section_id`='.$val['pid'].' AND A.pid=B.sector_id WHERE B.`section_id`='.$val['pid'].' AND A.pid=B.sector_id ORDER BY A.pid DESC');
							$prefix = '';
                            ...
                            <td><a href="<?php echo base_url();?>admin/edit_section/<?php echo $val['pid'];?>">Edit</a> | <a href="javascript:;" id="<?php echo $val['pid'];?>" class="deletesection">Delete</a></td>
                        </tr>
                        <?php $i++; } ?>
                    </tbody>
                </table>
