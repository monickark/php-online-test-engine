...
<tr>
	...
	<td width="998" height="35" bgcolor="#f1f1f1">
        ...
        <tr>
        <td width="270" class="subtitle2"><font color="#d43e85">Unanswered Questions</font></td>
...
echo form_open('unansTest/getquestion/',$attributes);
?>
	
	<?php
	//$totq=explode(",",$test['random_question_no']);
	$totq=$test['random_question_no'];
	$totalQuestions= sizeof($un_arr);
...
<a href="javascript:;" id="ucheck" style="margin-left:10px;">Clear Answer</a>
   ...
   <?php $tot_kqn = $_COOKIE['urqids']; $ar_t = explode(',', $tot_kqn); $qq_siz = sizeof($ar_t); echo sizeof($ar_t); ?>
         
         </td><td width="470" align="right" valign="top" style="vertical-align:top">
		 <?php if(!empty($tot_kqn)) { ?>
		 <?php if(($qno != $qq_siz)){ ?><a href="javascript:document.getElementById('testForm').submit();" id="menu"><img src="<?php echo base_url();?>images/next.jpg"></a><?php } ?> 
         <?php } elseif ($totalQuestions>=2) { ?>
